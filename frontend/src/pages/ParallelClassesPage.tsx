        ...
        {!selectedDegree ? (
          ...
          <div className="h-full max-w-6xl mx-auto px-6 pt-6 flex gap-6">
            ...
            <div className="flex-1 min-w-0 overflow-y-auto pb-6">
              <h2 className="font-bold text-[#333] text-base mb-3">Por selecionar</h2>
              {loadingCandidates ? (
                          ...
                          <tbody>
                            {hasWeeks
                              ? sortedWeeks.flatMap((weekKey, weekIdx) => [
                                  ...
                                  ...(weekMap.get(weekKey) ?? []).map((c, i) => renderRow(c, i)),
                                ])
            ...
            <div className="w-80 shrink-0 overflow-y-auto pb-6">
              <h2 className="font-bold text-[#333] text-base mb-3">Selecionadas</h2>
              {loadingCandidates ? (
                <CandidatesLoadingSkeleton />
              ) : groups.length === 0 ? (
