      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 16, width: 320 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            ...
            />
            <ul style={{ color: "var(--text)", fontSize: 13, margin: 0, paddingLeft: 20, lineHeight: 1.8 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            <label style={{ color: "var(--text)", fontSize: 14 }}>Confirmação da palavra-passe nova:</label>
            <input
              type="password"
              style={{
                padding: "10px 12px",
