/**
 * Gates for features whose backend endpoints don't exist yet (contracts C1-C7
...
export const FLAGS = {
  ...
  /** C5 — GET user course permissions */
  permissionsApi: envFlag(import.meta.env.VITE_FLAG_PERMISSIONS_API, false),
} as const;
