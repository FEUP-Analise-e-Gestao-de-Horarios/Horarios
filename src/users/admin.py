...
class CustomUserAdmin(UserAdmin):
    ...
    fieldsets = (
        ...
        (
            "Permissions",
            {"fields": ("is_staff", "is_active", "sent_email", "is_superuser")},
        ),
    )
    add_fieldsets = (
        (
    ...
    actions: ClassVar = ["send_confirmation_email"]
    ...
    def send_confirmation_email(self, request, queryset):
        ...
        self.message_user(request, "Sent email")
