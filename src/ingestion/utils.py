...
def pre_insert_red_blocks(
    ...
    30-minute time slot between 08:00 and 22:00, using integer encoding
    (e.g. 800 = 08:00, 830 = 08:30, ..., 2200 = 22:00).
    ...
    time_slots = [
        hour + minutes for hour in range(800, 2201, 100) for minutes in [0, 30]
    ]
