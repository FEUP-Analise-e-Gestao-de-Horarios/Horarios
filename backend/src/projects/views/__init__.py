from src.projects.views.classes import ProjectClassView, ProjectYearClassesView
...
from src.projects.views.subjects import ProjectSubjectView, ProjectYearSubjectsView
