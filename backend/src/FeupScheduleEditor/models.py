...
class AulaInfo:
    ...
    def formatted_docentes(self):
        ...
        return (
            ", ".join(str(docente) for docente in self.docentes_names)
            if self.docentes_names
            else ", ".join(str(docente) for docente in self.docentes_ids)
        )
    ...
    def __str__(self):
        ...
        return (
            f"AulaInfo(id={self.id}, cadeira_id={self.cadeira_id}, hora_inicio={self.hora_inicio}, "
...
class AulaChange:
    ...
    def check_horario(self):
        return (
            self.previous.hora_inicio != self.new.hora_inicio
            or self.previous.hora_fim != self.new.hora_fim
        )
    ...
    def __str__(self):
        """Human-friendly string representation."""
        return f"  Previous: {self.previous}\n  New: {self.new})"
